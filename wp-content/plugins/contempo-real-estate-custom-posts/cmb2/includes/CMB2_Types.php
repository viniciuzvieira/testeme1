...
class CMB2_Types {
	...
	public function text_currency() {
		return ( ! $this->field->get_param_callback_result( 'before_field' ) ? ct_currency() : ' ' ) . $this->input( array( 'class' => 'cmb2-text-currency', 'desc' => $this->_desc() ) );
	}
	...
	public function text_money() {
		return ( ! $this->field->get_param_callback_result( 'before_field' ) ? ct_currency() . '$ ' : ' ' ) . $this->input( array( 'class' => 'cmb2-text-money', 'desc' => $this->_desc() ) );
	}
